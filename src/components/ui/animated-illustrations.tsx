...
// Static illustrations - animations disabled
  ...
  <div className={className}>
    <svg viewBox="0 0 200 200" className="w-full h-full">
      ...
      <g>
        ...
        <circle cx="50" cy="160" r="1" fill="#FFD700" />
      </g>
    </svg>
  </div>
);
...
export const AnimatedDesk = ({ className = "" }: { className?: string }) => (
  <div className={className}>
    <svg viewBox="0 0 300 200" className="w-full h-full">
      ...
      {/* Computer Monitor */}
      <rect x="80" y="60" width="140" height="80" rx="4" fill="#2C3E50" />
      ...
      <rect x="255" y="85" width="2" height="20" fill="#2C3E50" />
      <rect x="260" y="88" width="2" height="17" fill="#E74C3C" />
      <rect x="265" y="90" width="2" height="15" fill="#3498DB" />
    </svg>
  </div>
);
...
export const SuccessAnimation = ({ className = "" }: { className?: string }) => (
  <div className={`${className}`}>
    <svg viewBox="0 0 100 100" className="w-16 h-16 text-green-500">
      ...
      <path d="M30 50 L45 65 L70 35" stroke="currentColor" strokeWidth="4" fill="none" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  </div>
);
